...
import cat.udl.eps.raise.domain.Repository;
...
public interface RepositoryRepository extends CrudRepository<Repository, Long> {
   ...
   */
   ...
   Optional<Repository> findByName(@Param("name") String name);

   Optional<Repository> findByNameStartsWith(@Param("name") String name);
